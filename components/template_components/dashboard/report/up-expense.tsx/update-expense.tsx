...
export default function UpdateExpense({ isModalOpen, onClose, expense }: UpdateExpenseProps) {
    ...
    return (
        <AnimatePresence>
            <motion.div
                className="fixed inset-0 z-[1111] flex items-center justify-center bg-black bg-opacity-50"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
            >
                                ...
                                form.type === "input" ? (
                                    ...
                                    <div key={`${form.name}-${index}`}>
                                        ...
                                        >
                                            ...
                                            <SelectContent className="z-[1200]">
                                                <SelectGroup>
                                                    <SelectLabel className="font-siemreap">{t('day')}</SelectLabel>
                                                    {days.map((day) => (
                                    ...
                                    <div key={`${form.name}-${index}`}>
                                        ...
                                        >
                                            ...
                                            <SelectContent className="z-[1200]">
                                                <SelectGroup>
                                                    <SelectLabel className="font-siemreap">{t('month')}</SelectLabel>
                                                    {months.map((month) => (
                                    ...
                                    <div key={`${form.name}-${index}`}>
                                        ...
                                        >
                                            ...
                                            <SelectContent className="z-[1200]">
                                                <SelectGroup>
                                                    <SelectLabel className="font-siemreap">{t("year")}</SelectLabel>
                                                    {years.map((year) => (
